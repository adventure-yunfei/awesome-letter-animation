...
/***/ function(module, exports, __webpack_require__) {
	...
	var letterConfigs_1 = __webpack_require__(9);
	var Letter_1 = __webpack_require__(8);
	var svg = d3
	    .select('body')
	    ...
	    .attr('height', 800);
	var prevLetter = null;
	var offset = { x: 300, y: 200 };
	Object.keys(letterConfigs_1.default)
	    .forEach(function (key, idx) {
	    var letterCfg = letterConfigs_1.default[key];
	    var baseX = 0, baseY = 0;
	    if (prevLetter) {
	        baseX = prevLetter.getBoundary().right + 10;
	    }
	    var letter = new Letter_1.default(letterCfg.path);
	    letter.appendNodes(svg, offset);
	    var boundary = letter.getBoundary();
	    offset.x += boundary.right + 10;
	});
	Letter_1.default.animateLetters();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Letter = (function () {
	    function Letter(path) {
	        this.path = path;
	    }
	    Letter.animateLetters = function () {
	    ...
	    Letter.prototype.getBoundary = function () {
	        var path = this.path;
	    ...
	    Letter.prototype.appendNodes = function ($svg, offset) {
	        if (offset === void 0) { offset = { x: 0, y: 0 }; }
	        this._appendFillPath($svg, offset);
	        this._appendLinePath($svg, offset);
	    };
	    Letter.prototype._appendFillPath = function ($svg, offset) {
	        if (offset === void 0) { offset = { x: 0, y: 0 }; }
	        var offsetX = offset.x;
	        var offsetY = offset.y;
	        var pathd = this.path.map(function (_a, idx) {
	            var x = _a[0], y = _a[1];
	            var cmd = idx === 0 ? 'M' : 'L';
	    ...
	    Letter.prototype._appendLinePath = function ($svg, offset) {
	        if (offset === void 0) { offset = { x: 0, y: 0 }; }
	        var offsetX = offset.x;
	        var offsetY = offset.y;
	        var path = this.path;
