...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var letterAnimations_1 = __webpack_require__(1);
	var d3 = __webpack_require__(2);
	var letter_a = letterAnimations_1.default.a, letter_m = letterAnimations_1.default.m;
	var svg = d3
	    .select('body')
	    .append('svg')
	    .attr('width', 1800)
	...
	var prevPath = null;
	Object.keys(letterAnimations_1.default)
	    .forEach(function (key, idx) {
	    var letter = letterAnimations_1.default[key];
	    var x = 0, y = 0;
	    if (prevPath) {
